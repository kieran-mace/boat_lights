...
labels = []
# Interior Lights
label = Label(win, text="Interior Lights", font=myFont)
label.grid(1, 1)
labels.append(label)
...
# Exterior Lights
label = Label(win, text="Exterior Lights", font=myFont)
label.grid(1, 2)
labels.append(label)
...
# Navigation Lights
label = Label(win, text="Navigation Lights", font=myFont)
label.grid(1, 3)
labels.append(label)
...
# Electronics
label = Label(win, text="Electronics", font=myFont)
label.grid(1, 6)
labels.append(label)
